      ...
      <div className="container-lg bg-white rounde p-5">
        ...
        <div className="row gap-4">
          ...
          <div className="col-lg bg-light rounded p-5">
            ...
            <p>Este projeto das Cartas de Tarot foi desenvolvido como uma forma de praticar e consolidar meus conhecimentos em <strong>React</strong>, com ênfase no uso de diversos <strong>hooks</strong> (<strong>useState</strong>, <strong>useEffect</strong>, <strong>useRef</strong>) para controle de estado, efeitos colaterais e manipulação do DOM. Utilizei também <strong>Bootstrap</strong> para o layout responsivo e estilização, além de <strong>react-router-dom</strong> para a navegação entre páginas. Os dados exibidos — nomes, significados e descrições das cartas — são carregados a partir de um arquivo <strong>JSON</strong>. Esse conteúdo foi traduzido automaticamente e adaptado.</p>
            <p>Neste projeto, um dos destaques é a funcionalidade de sorteio de uma carta de forma <strong>randômica</strong>, simulando a aleatoriedade de um baralho físico. Essa escolha é feita por meio da geração de números pseudoaleatórios, um processo comum em computação que, embora pareça aleatório, é na verdade determinado por <strong>algoritmos</strong> que se baseiam em valores como o tempo do sistema. Isso mostra que não existe aleatoriedade "real" no ambiente digital, apenas simulações suficientemente imprevisíveis para fins práticos. Essa técnica adiciona um elemento de surpresa à interação, contribuindo para a experiência do usuário.</p>
            <p>De modo geral, este projeto foi um exercício de <strong>lógica, interatividade e interface</strong>, com foco na entrega de uma experiência agradável e envolvente ao usuário.</p>
