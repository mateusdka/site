        ...
        <div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Para cada <strong>R$ 1.000,00</strong> investidos em Campanhas Digitais, 
                                é possível alcançar, em média, <strong>80.000 pessoas</strong> com até <strong>3 anúncios</strong> ao 
                                longo de um período determinado (<strong>semanal ou mensal</strong>, conforme a estratégia adotada). 
                                Esta métrica é um benchmark conhecido e reconhecido no mercado.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="modalEmpresa" tabindex="-1" aria-labelledby="modalEmpresa" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>A escolha dos canais de mídia é fundamental para o sucesso de uma estratégia digital, 
                                pois cada plataforma oferece formatos e segmentações específicas que podem ser mais 
                                eficientes para determinados públicos e objetivos.</p>
                            <ul>
                            ...
                            <p>Embora todos os canais sejam relevantes, o investimento deve ser direcionado conforme 
                                o potencial de cada um para a estratégia da sua empresa. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>A <strong>Taxa de Cliques (CTR)</strong> em Campanhas Digitais geralmente varia entre 0,4% e 2% 
                        do total de Visualizações, dependendo do canal utilizado, do público-alvo e da qualidade do anúncio. 
                        No entanto, na maioria dos casos, essa taxa tende a ficar na faixa de 0,8% a 1%, sendo esse um valor 
        ...
        <div class="modal fade" id="modalConversao" tabindex="-1" aria-labelledby="modalConversao" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>A <strong>Taxa de Conversão</strong> em Campanhas Digitais – seja para compras em e-commerces ou 
                        geração de leads – tende a variar entre 0,5% e 5% do total de visitantes que acessaram a página de destino 
                        (ou seja, daqueles que clicaram no anúncio). Esse percentual depende de diversos fatores, como a experiência 
                        do usuário no site, a oferta apresentada e a qualidade do tráfego gerado. No entanto, na maioria dos 
                        casos, a taxa de conversão costuma ficar entre 1% e 2%, sendo esse um valor mais comum para 
                        campanhas bem estruturadas.</p>
        ...
        <div class="modal fade" id="modalTicketMedio" tabindex="-1" aria-labelledby="modalTicketMedio" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>O <strong>Ticket Médio</strong> é um indicador usado para medir o valor médio gasto por cliente em
                        cada compra (conversão). Ele é calculado dividindo o faturamento total pelo número de vendas realizadas
                        em um determinado período.</p>
